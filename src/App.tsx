...
function App() {
  ...
  return (
    <div className="container">
      ...
      <section id="intro">
        <p>
          <strong>Background:</strong> This is a tool to automate the generation
          of accessible enterprise UI color palettes. It draws inspiration from
          <a href="https://www.radix-ui.com/colors/custom" target="_blank">
            Radix UI's custom color palette tool
          </a>
          , but its color generation rules are mostly based on those I laid out
          in a
          <a
